...
All notable changes to the PaymentHub SDK will be documented in this file.
...
- **Rich Error Classes**
  - `PaymentHubError` - Base error class
...
- **Type Guards**
  - `isPaymentHubError()` - Check if error is SDK error
